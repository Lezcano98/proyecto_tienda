   ...
   public class Consolas
    {
        ...
        public string imagen_consola;
        public int precio;
        public string descripcion;
        public int codigo_consola;

        public Consolas(int opc, string nombre_consola, string imagen_consola, int precio, string descripcion, int codigo_consola)
        {
            this.opc = opc;
        ...
        public string Imagen_consola { get => imagen_consola; set => imagen_consola = value; }
