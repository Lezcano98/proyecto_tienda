<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registrar_Usu.aspx.cs" Inherits="Electron.Registrar_Usu" %>
...
<body class="bg-gradient-primary">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="principal.aspx">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="LOGING.aspx">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="">Electronica</a>
            <a class="collapse-item" href="">Video juegos</a>
          </div>
        </div>
      </li>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <div class="topbar-divider d-none d-sm-block"></div>
                    ...
                    <!-- PERFIL DEL USUARIO INGRESADO-->
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">USUARIO ACTUAL</span>
            <img class="img-profile rounded-circle" src="img/perfil_vacio.jpg">
              </a>
              <!-- Dropdown PARA MOSTRAR LA INFORMACION -->
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="LOGING.aspx" data-toggle="modal" data-target="#logoutModal">
